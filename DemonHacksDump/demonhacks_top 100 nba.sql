...
--
-- Host: localhost    Database: demonhacks
-- ------------------------------------------------------
...
--
-- Table structure for table `top 100 nba`
--

DROP TABLE IF EXISTS `top 100 nba`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `top 100 nba` (
  `PK` int(11) NOT NULL,
